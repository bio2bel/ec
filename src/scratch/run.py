...
from bio2bel_ec.tree import give_edge, edge_descpription, non_standard_ec_id, populate_tree

#print(give_edge('1.1.1.1'))
#print(edge_descpription('1.1.-.-'))
#print(non_standard_ec_id('1.1.-.-'))
